...
import fr.ravenfeld.livewallpaper.library.objects.simple.BackgroundGIFSwipe;

public class RendererBackgroundGIFSwipe extends RajawaliRenderer implements
		SharedPreferences.OnSharedPreferenceChangeListener {
	private final SharedPreferences mSharedPreferences;

	private BackgroundGIFSwipe mBackgroundGIFSwipe;

	public RendererBackgroundGIFSwipe(Context context) {
		super(context);
	...
	protected void initScene() {
		...
		addChild(mBackgroundGIFSwipe.getObject3D());
	...
	public void onDrawFrame(GL10 glUnused) {
		...
		if (mBackgroundGIFSwipe != null) {
			try {
				mBackgroundGIFSwipe.update();
			} catch (TextureException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		...
		if (mBackgroundGIFSwipe != null) {
			mBackgroundGIFSwipe.surfaceChanged(width, height);
		}
	}
	...
	public void onOffsetsChanged(float xOffset, float yOffset,
			...
			int yPixelOffset) {
		if (mBackgroundGIFSwipe != null) {
			mBackgroundGIFSwipe.offsetsChanged(xOffset);
		}
	}
}
